#!/usr/bin/env python3
"""
Flask Routes for PDF Reporting - Enhanced integration with PZEM dashboard
Provides web interface and API endpoints for report generation
"""
...
# Note: We create new database managers for each request to avoid connection conflicts
...
<body>
    <div class="container">
        ...
        <a href="/pln-match" class="back-link" style="margin-left: 16px;">
            <i class="fas fa-balance-scale"></i> Cocokkan kWh PLN
        </a>
        <a href="/docs/perhitungan" class="back-link" style="margin-left: 16px;">
...
def generate_report():
    """API endpoint for report generation with timeout handling"""
    try:
...
def report_summary():
    ...
    try:
        # Create fresh database manager for this request
        from report_generator import DatabaseManager
        db_manager = DatabaseManager()
